            ...
            <div className='container mx-auto px-4 py-12'>
                <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
                    <div>
                        ...
                        <p className='text-gray-400'>저희 회사는 최고의 서비스를 제공하기 위해 노력합니다.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className='space-y-2 text-gray-400'>
                            <li>대구광역시 수성구</li>
                            <li>달구벌대로 123번지</li>
                            <li>전화번호: 053-000-0000</li>
                            <li>이메일: test-dummy@example.coom</li>
                        </ul>
                    </div>
                    <div>
                        <h3 className='text-xl font-bold mb-4'>소셜 미디어</h3>
                        <div className='flex center-x-4'>
                ...
                <div className='border-t border-gray-800 mt-8 pt-8 text-center text-gray-400'>
                    <p>&copy; 2025 Dev-Kim Study Company. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
