  ...
  return (
    <div className='p-4 md:p-6 max-w-7xl mx-auto md:py-32'>
      ...
      <div className='overflow-x-auto'>
        <table className='min-w-full bg-white border rounded-lg border-blue-200'>
          <thead className='bg-gray-50'>
            <tr>
              <th className='px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-winder w-[8%]'>
                번호
              </th>
              <th className='px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-winder w-auto'>
                제목
              </th>
              <th className='px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-winder w-[15%]'>
                작성일
              </th>
              <th className='px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-winder w-[8%]'>
                조회수
