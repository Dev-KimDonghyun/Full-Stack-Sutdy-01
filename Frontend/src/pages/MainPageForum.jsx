    ...
    <div className='bg-white'>
      <div className='container mx-auto px-4 py-28 lg:py-0 max-w-6xl'>
        <div className='text-center mb-6'>
          <h2 className='text-4xl bg:text-5xl font-bold text-gray-900'>
            업무 게시판
          </h2>
        </div>
...
// post는 뭐 대단한게 아니라 그냥 map 함수 변수인 것이와요
// &&는 조건부 연산자임. false일때는 아무것도 반환하지 않음

export default MainPageForum;