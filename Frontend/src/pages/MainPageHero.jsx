      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-36'>
        <div className='flex flex-col lg:flex-row items-center justify-between gap-12'>
          <div className='flex-1 text-center lg:text-left'>
            ...
            <div className='flex sm:flex-row flex-col gap-4 justify-center lg:justify-start'>
              ...
              <button className='px-8 py-4 bg-white text-blue-600 border-2 rounded-lg border-blue-600 hover:bg-blue-50 transition-colors duration-300 text-lg font-semibold'>
                더 알아보기
              </button>
            </div>
          </div>
          <div className='flex-1 w-full max-w-2xl lg:max-w-none'>
            <div className='relative'>
              <img src='https://www.splcenter.org/wp-content/uploads/2016/09/pepethefrog.png' className='relative rounded-2xl shadow-2xl w-full object-cover transform hover:scale-[1.02] transition-transform duration-300' />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto'>
          {[
            ...
            <div key={index} className='text-center'>
              ...
              <div className='text-gray-900 mb-8'>{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
